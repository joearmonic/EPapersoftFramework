...
namespace $safeprojectname$
{
    ...
    public class WeeklyProgramming : Programming
    {
        public WeeklyProgramming(ProcessWorkerBase worker) : base(worker)
        {
        }
        ...
        protected override void SetupSchedule()
        {
            ...
            {
                throw new InvalidOperationException("An appointment must be defined for Weekly programming");
            }
